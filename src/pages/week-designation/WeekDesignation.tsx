...
export const WeekDesignation = () => {
    ...
    const handleAbsent = async (reason: string) => {
        ...
        await toast.promise(http.post(`/participants/${participantId}/incidences`, { reason }),
            {
    ...
    switch (page) {
        ...
        case 'screen':
            return (<div className="flex flex-col justify-center items-center relative gap-1 max-w-[500px] m-auto">
                                    ...
                                    <div className="flex justify-end mb-2 relative">
                                        {participantId && (
                                            <>
                                                <div>
                                                    <span className={
                                                        `text-xs px-2 py-1 rounded-full absolute -top-4 -right-4
